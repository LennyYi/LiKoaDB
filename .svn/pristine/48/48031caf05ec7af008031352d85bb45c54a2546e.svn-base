if object_id(N'[NOVA].[funXMLReplaceSpecNRevert]') is not null
begin
	drop function [NOVA].[funXMLReplaceSpecNRevert]
end
GO
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [NOVA].[funXMLReplaceSpecNRevert](@input nvarchar(4000))
