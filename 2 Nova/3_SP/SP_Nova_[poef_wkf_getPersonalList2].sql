...
INNER join (select distinct request_no,flow_id from teflow_wkf_process_trace where node_id>0 and handle_type in ('03','05') and current_processor=@staff_code) t8 on t1.request_no =t8.request_no--1.1
