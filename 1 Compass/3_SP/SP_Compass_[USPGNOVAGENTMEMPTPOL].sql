IF EXISTS (SELECT * FROM SYSOBJECTS WHERE ID = OBJECT_ID('dbo.USPGNOVAGENTMEMPTPOL') AND sysstat & 0xf = 4)
	drop procedure dbo.USPGNOVAGENTMEMPTPOL
GO
...
SET ANSI_PADDING ON
GO
CREATE PROCEDURE dbo.USPGNOVAGENTMEMPTPOL
...
/*******************************************************************
	...
	VERSION	  PIRNO		PROGRAMMER	REMARK		DATE		PURPOSE
		...
		5.1	  NOVA		Issac Zhu				05/22/2015	Change Benefit Max to Benefit Amount
********************************************************************/
